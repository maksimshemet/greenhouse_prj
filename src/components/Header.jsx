          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="hidden md:flex flex-col">
              <div className="flex items-center mt-1">
                ...
                <span className="text-sm text-stone-950">063 660 96-56</span>
              </div>
              <div className="flex items-center mt-1">
                <div className="w-1 h-5 bg-green-500 mr-2"></div>
                <Phone size={16} className="text-green-600 mr-1" />
                <span className="text-sm text-stone-950">066 092 16-86</span>
              </div>
            </div>
            
            {/* CTA Buttons */}
            <div className="flex flex-col space-y-1">
              <button onClick={callButtonHandler} className="bg-yellow-300 text-gray-800 px-4 py-1 text-sm font-medium hover:bg-yellow-400 transition">
                ЗАМОВИТИ ДЗВІНОК
              </button>
            </div>
          </div>
